...
export const register = async (req, res) => {
    ...
    try {
        ...
        if (currentTrip !== undefined) newUser.currentTrip = currentTrip; else newUser.currentTrip = null;
...
export const login = async (req, res) => {
    try {
        const {
            email, password, currentLocation, isOnline, lastLocationUpdate, currentTrip,
        } = req.body;
        ...
        userFound.lastLocationUpdate = lastLocationUpdate || userFound.lastLocationUpdate;
...
export const profile = async (req, res) => {
    try {
        const userFound = await User.findOne({_id: req.userId}).select("-password -__v -createdAt -updatedAt -_id");
        ...
        return res.json({
            message: "User profile retrieved successfully", user: userFound,
        });
    } catch (error) {
